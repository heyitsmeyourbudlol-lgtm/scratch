...
| A45 | MLA (Multi-head Latent Attention) | KV | DeepSeek-V2 MLA; interpretability study cites **81% KV-cache reduction** | Serve-side; **not weight compression** | N/A | [TransMLA / DeepSeek-V2 cite](https://arxiv.org/html/2502.07864v2); [MLA bottleneck study](https://arxiv.org/html/2607.23054); [attention comparison note](https://cyk1337.github.io/blog/2024/memory-efficient-attention/) | measured |
| A46 | GQA | KV | Grouped KV heads; cache ↓ vs MHA by `#KV_heads/#Q_heads` | Not weight | N/A | [attention comparison note](https://cyk1337.github.io/blog/2024/memory-efficient-attention/) (cites arXiv:2305.13245) | measured |
| A47 | MQA | KV | Single KV head; max KV compression among head-sharing | Not weight | N/A | [attention comparison note](https://cyk1337.github.io/blog/2024/memory-efficient-attention/) | paper |
| A48 | YOCO | KV / arch | Cache KV **once** (decoder–decoder); orders-of-magnitude infer memory vs long context claimed | Not weight | N/A | [arXiv:2405.05254](https://arxiv.org/html/2405.05254v1) | measured |
| A49 | CLA (Cross-Layer Attention) | KV | Share KV across adjacent layer groups | Not weight | N/A | Surveyed in [NAACL CLA study PDF](https://aclanthology.org/2025.naacl-short.34.pdf) | paper |
...
| Fit | Methods |
| --- | --- |
| Strong MoE grain | A11–A14, A19–A24, A28, A33, A36–A44, A59–A65, A69, A72–A74, A78, A81–A82, A84, A86, A90–A91, A95–A96, A98–A99 |
| Later SSD/hybrid serve | A50–A53, A58; KV A45–A49 for decode mem |
| Do not confuse with unique-param north star | A45–A49 (KV), A08/A14/A16–A18/A66–A68/A70–A71/A75–A76/A85/A93 (bytes-quant ≠S), A77 (serve-util), A90 (disk/codec ≠S), pure speed claims on A50; never zstd/PagedAttention as \(S\) |
...
*End Lane A (2026-09-06; curate waves A59–A78 + A79–A86 + A87–A94).*
