...
class TestPeerSelfHeal(unittest.TestCase):
    ...
    def test_scan_ram_ballast_skips_gpu_compute_when_ok(self) -> None:
        ps_out = (
            "3321929 3500000 /home/arnavrastogi/miniconda3/bin/python3 "
            "/home/arnavrastogi/Automation/scripts/dgx_gpu_compute.py --forever\n"
        ...
        runaway = (
            "3321929 16000000 /home/arnavrastogi/miniconda3/bin/python3 "
            "/home/arnavrastogi/Automation/scripts/dgx_gpu_compute.py --forever\n"
        )
        with unittest.mock.patch.object(heal, "_avail_ram_gb", return_value=4.0):
            with unittest.mock.patch.object(
